...
public class SampleHandler extends AbstractHandler {
	...
	private static final String CONSOLE_NAME = "691 AST example: How many methods in the project?";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		DetectMethodDeclaration detectMethods = new DetectMethodDeclaration();
		detectMethods.execute(event);
